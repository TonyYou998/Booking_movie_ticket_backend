...
public class HeThongRapSeeder {
	...
	public void heThongRapSeeder(ContextRefreshedEvent event) {
		logger.info("-------------------running he thong rap seeder-----------------------");
		seedHeThongRap();
	...
	private void seedHeThongRap() {
		...
		if(heThongRap.size()<=0) {
			...
			heThongRap.add(newHeThongRap);
			heThongRap.add(newHeThongRap2);
			heThongRap.add(newHeThongRap3);
			heThongRap.add(newHeThongRap4);
			heThongRap.add(newHeThongRap5);
			long start = System.currentTimeMillis();
			repository.saveAll(heThongRap);
